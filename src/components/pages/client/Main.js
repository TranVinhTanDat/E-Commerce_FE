...
const RecursiveCategory = ({ category, activeCategory, setActiveCategory, level = 0 }) => {
    ...
    return (
        <>
            <li className="nav-item" style={{ marginLeft: `${level * 15}px` }}>
                <div className="d-flex align-items-center">
                    {category.subCategories?.length > 0 && (
                        <i
                            className={`fas fa-caret-${isExpanded ? 'down' : 'right'} me-2`}
...
export default function Main() {
    ...
    // Hàm đệ quy để kiểm tra xem một danh mục có thuộc danh mục cha hay không
    const isCategoryOrSubcategory = (productCategory, selectedCategoryName) => {
        if (!productCategory) return false;

        // Kiểm tra danh mục trực tiếp
        if (productCategory.name === selectedCategoryName) {
            return true;
        }
        ...
        while (currentCategory.parent) {
            if (currentCategory.parent.name === selectedCategoryName) {
                return true;
            }
    ...
    // Lọc sản phẩm theo danh mục (bao gồm danh mục con)
    const filteredProducts = activeCategory === 'All'
        ? products
        : products.filter((product) => isCategoryOrSubcategory(product.category, activeCategory));
                    ...
                    <div className="row g-5 align-items-center">
                        <div className="col-md-12 col-lg-7">
                            ...
                            <h1 className="mb-5 display-3 text-primary">
                                Rau củ & Trái cây hữu cơ
                            </h1>
                        </div>
                        <div className="col-md-12 col-lg-5">
                            <Carousel id="carouselId" className="position-relative">
                                <Carousel.Item>
                                    <img
                            ...
                            <div className="featurs-item text-center rounded bg-light p-4">
                                ...
                                <div className="featurs-content text-center">
                                    ...
                                    <p className="mb-0" style={{ color: 'black' }}>
                                        Miễn phí cho đơn hàng trên $300
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="tab-pane fade show p-0 active">
                                            ...
                                            >
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4>{product.name}</h4>
                                                        <p className="DesProduct" style={{ color: 'black' }}>
                                                            {product.description}
                                                        </p>
                                    ...
                                    {!showAllProducts && filteredProducts.length > 8 && (
                                        <div className="text-center mt-4">
                                            <button
                                                className="btn btn-primary btn-custom-view-more"
            ...
            <div className="container-fluid py-5">
                <div className="container py-5">
                    <div className="text-center mx-auto mb-5" style={{ maxWidth: '700px' }}>
                        ...
                        <p style={{ color: 'black' }}>
                            Khám phá những sản phẩm được yêu thích nhất với chất lượng vượt trội.
                        </p>
                    </div>
                    <div className="row g-4">
                        {loading ? (
                                    ...
                                    <div className="row align-items-center">
                                        <div className="col-12 text-center">
                                            <Link to={`/shopdetail/${product.id}`}>
                                                <img
                                                    src={product.image}
                                                    className="product-image img-fluid rounded w-100"
                                                    alt={product.name}
                                                />
                                            </Link>
                                        </div>
                                        <div className="col-12 mt-3 text-center">
                                            <Link to={`/shopdetail/${product.id}`} className="h5 d-block">
                                                {product.name}
                                            </Link>
                                            ...
                                            <h4 className="mb-3">{formatCurrency(product.price)}</h4>
                                            <a
                                                href="#"
                                                className="btn border border-secondary rounded-pill px-3 text-primary"
                                                onClick={() => handleAddToCart(product.id)}
                    ...
                    <div className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item img-border-radius bg-light rounded p-4">
                            <div className="position-relative">
                                ...
                                <div className="mb-4 pb-4 border-bottom border-secondary">
                                    <p className="mb-0">
                                        Sản phẩm chất lượng cao, dịch vụ tuyệt vời. Tôi sẽ tiếp tục mua sắm tại đây!
                                    </p>
                                </div>
                        ...
                        <div className="testimonial-item img-border-radius bg-light rounded p-4">
                            <div className="position-relative">
                                ...
                                <div className="mb-4 pb-4 border-bottom border-secondary">
                                    <p className="mb-0">
                                        Rau củ tươi ngon, giao hàng nhanh chóng. Rất hài lòng!
                                    </p>
                                </div>
                                <div className="d-flex align-items-center flex-nowrap">
                                    <div className="bg-secondary rounded">
                        ...
                        <div className="testimonial-item img-border-radius bg-light rounded p-4">
                            <div className="position-relative">
                                ...
                                <div className="mb-4 pb-4 border-bottom border-secondary">
                                    <p className="mb-0">
                                        Giá cả hợp lý, chất lượng vượt mong đợi. Tôi rất khuyến khích!
                                    </p>
                                </div>
                                <div className="d-flex align-items-center flex-nowrap">
                                    <div className="bg-secondary rounded">
